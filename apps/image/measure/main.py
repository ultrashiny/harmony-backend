...
async def createReportImages(id, f_canvas, s_canvas, points, lines):
    ...
    create_eye_aspect_ratio_image(f_url, points, DIR, 14)
    ...
    create_mandibular_plane_angle_image(points, RLs, 24, 2, s_canvas)
    create_ramus_to_mandible_ratio_image(points, RLs, 25, 3, s_canvas)
    create_facial_convexity_glabella_image(points, RLs, 26, 4, s_canvas)
    create_submental_cervical_angle_image(points, RLs, 27, 5, s_canvas)
